...
import com.xypsp.admin.domain.mapper.admin.AdminUserMapper;
import com.xypsp.admin.filter.OptionsRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurityConfig(AdminUserMapper adminUserMapper) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/upload","/session/findByUsername", "/login","/wxOpen/**").permitAll()
